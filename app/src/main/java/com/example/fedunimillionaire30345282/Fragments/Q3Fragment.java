...
public class Q3Fragment extends Fragment implements View.OnClickListener {
    ...
    public Q3Fragment(ArrayList<TestQuestion> questions, int savings){
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        TestQuestion question = questions.get(2);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.btnB:
                getFragmentManager()
                        .beginTransaction()
                        .replace(R.id.question_fragment, new Q4Fragment(questions, savings))
                        .commit();
                break;
        }
    }
