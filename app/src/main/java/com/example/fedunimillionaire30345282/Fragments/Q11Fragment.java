...
public class Q11Fragment extends Fragment implements View.OnClickListener {
    ...
    public Q11Fragment(ArrayList<TestQuestion> questions, int savings){
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        TestQuestion question = questions.get(10);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.btnA:
                getFragmentManager()
                        .beginTransaction()
                        .replace(R.id.question_fragment, new Q11Save(questions, savings))
                        .commit();
                break;
