...
public class Q4Fragment extends Fragment implements View.OnClickListener {
    ...
    public Q4Fragment(ArrayList<TestQuestion> questions, int savings){
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        TestQuestion question = questions.get(3);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.btnD:
                getFragmentManager()
                        .beginTransaction()
                        .replace(R.id.question_fragment, new Q5Fragment(questions, savings))
                        .commit();
                break;
