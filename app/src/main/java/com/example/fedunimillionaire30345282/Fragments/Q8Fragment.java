...
public class Q8Fragment extends Fragment implements View.OnClickListener {
    ...
    public Q8Fragment(ArrayList<TestQuestion> questions, int savings){
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        TestQuestion question = questions.get(7);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.btnB:
                getFragmentManager()
                        .beginTransaction()
                        .replace(R.id.question_fragment, new Q9Fragment(questions, savings))
                        .commit();
                break;
        }
    }
