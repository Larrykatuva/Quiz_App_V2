...
public class Q2Fragment extends Fragment implements View.OnClickListener {
    ...
    public Q2Fragment(ArrayList<TestQuestion> questions, int savings){
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        TestQuestion question = questions.get(1);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.btnC:
                getFragmentManager()
                        .beginTransaction()
                        .replace(R.id.question_fragment, new Q3Fragment(questions, savings))
                        .commit();
                break;
        }
    }
