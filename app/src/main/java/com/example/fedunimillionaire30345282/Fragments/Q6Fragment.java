...
public class Q6Fragment extends Fragment implements View.OnClickListener {
    ...
    public Q6Fragment(ArrayList<TestQuestion> questions, int savings){
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        TestQuestion question = questions.get(5);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.btnD:
                getFragmentManager()
                        .beginTransaction()
                        .replace(R.id.question_fragment, new Q6Save(questions, savings))
                        .commit();
                break;
