...
public class Q1Fragment extends Fragment implements View.OnClickListener {
    ...
    public Q1Fragment(ArrayList<TestQuestion> questions){
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.q1_fragment, container, false);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.btnB:
                ...
                getFragmentManager()
                        .beginTransaction()
                        .replace(R.id.question_fragment, new Q1Save(questions,savings))
                        .commit();
                break;
        }
    }
