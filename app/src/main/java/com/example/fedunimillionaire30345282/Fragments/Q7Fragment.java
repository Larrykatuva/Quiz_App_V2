...
public class Q7Fragment extends Fragment implements View.OnClickListener {
    ...
    public Q7Fragment(ArrayList<TestQuestion> questions, int savings){
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        TestQuestion question = questions.get(6);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.btnA:
                getFragmentManager()
                        .beginTransaction()
                        .replace(R.id.question_fragment, new Q8Fragment(questions,savings))
                        .commit();
                break;
