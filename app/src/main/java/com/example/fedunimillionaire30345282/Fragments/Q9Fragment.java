...
public class Q9Fragment extends Fragment implements View.OnClickListener {
    ArrayList<TestQuestion> questions = new ArrayList<TestQuestion>();
    private TextView questionT, A, B, C, D;
    private Button btnA, btnB, btnC, btnD;
    int savings;

    public Q9Fragment(ArrayList<TestQuestion> questions, int savings){
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        TestQuestion question = questions.get(8);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.btnB:
                getFragmentManager()
                        .beginTransaction()
                        .replace(R.id.question_fragment, new Q10Fragment(questions, savings))
                        .commit();
                break;
        }
    }
