...
public class Q5Fragment extends Fragment implements View.OnClickListener {
    ...
    public Q5Fragment(ArrayList<TestQuestion> questions, int savings){
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        TestQuestion question = questions.get(4);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.btnC:
                getFragmentManager()
                        .beginTransaction()
                        .replace(R.id.question_fragment, new Q6Fragment(questions, savings))
                        .commit();
                break;
        }
    }
