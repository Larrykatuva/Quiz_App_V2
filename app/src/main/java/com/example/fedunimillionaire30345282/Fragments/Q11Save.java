...
public class Q11Save extends Fragment implements View.OnClickListener{
    ArrayList<TestQuestion> questions;
    int savings;

    public Q11Save(ArrayList<TestQuestion> questions, int savings){
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.save11_fragment, container, false);
    }
